  ...
  return (
    <div className='creds-form-signup-cont'>
        <div className='creds-form-signup'>
            ...
            <p style={{textAlign: 'center', fontSize: '12px'}}>Sign up to see photos and videos from your friends.</p>
            ...
            <p style={{textAlign: 'center', fontSize: '12px'}}>People who use our service may have uploaded your contact information to Instagram. 
                <p style={{fontWeight: 'bold'}}>Learn More</p>
            </p>

            <p style={{textAlign: 'center', fontSize: '12px'}}>By signing up, you agree to our Terms , Data Policy and Cookies Policy .</p>
        </div>
